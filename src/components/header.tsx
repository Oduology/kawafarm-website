  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-slate-200/60 bg-white/78 backdrop-blur-xl dark:border-white/10 dark:bg-tech/72">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3" aria-label="Kawafarm home">
          <span className="grid h-11 w-11 place-items-center rounded-xl bg-farm text-lg font-black text-white shadow-glow">K</span>
          <span>
            <span className="block text-base font-black tracking-normal text-slate-950 dark:text-white">Kawafarm</span>
            <span className="block text-xs font-medium text-slate-500 dark:text-slate-400">Farm-first agritech</span>
          </span>
        </Link>
